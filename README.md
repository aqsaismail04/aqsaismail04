...
📍 2nd Semester | Aspiring Software / IT / AI Developer

- 🌱 Currently learning **C++, Digital Logic Design & Calculus**
- 🎯 Looking for **internship opportunities in Software / IT / AI**
...
> C++ with SFML — graphical snake game with classic Nokia gameplay

### ♟️ Chess Game Console
> Fully playable console chess with complete move validation in C++

### 🎓 Student Portal Console App
> Simulates student portal — course management & grade display in C++

### 🧮 Grade Calculator & Password Strength Checker
> GPA computation + password strength feedback system in C++

### 🎮 Rock Paper Scissors Game
> Interactive C++ console game with randomized AI & score tracking

---

## 🏆 Achievements & Certifications

- 🥇 **MOS** — Microsoft Office Specialist (Official Microsoft Certification)
- 🏛️ **IEEE Techathon 2.0** — Designed 5 certificates, received official team approval
- 🎪 **UCP Career Connect 2026** — Operations Team Member
- 🌸 **Jashn-e-Baharaan** — Certificate of Achievement
- 💼 **IGC Logistics Lead** — Noor e Hijab event
- 🤝 **Team ISS Certificate** — Inclusive Student Society
